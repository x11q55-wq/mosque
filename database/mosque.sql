-- ====================================================
-- جمعية العناية بالمساجد — قاعدة البيانات الكاملة
...
('org_name', 'جمعية العناية بالمساجد', 'text', 'general', 'اسم المنظمة', NOW()),
...
('org_about', 'جمعية العناية بالمساجد جمعية خيرية غير ربحية مرخصة من وزارة الموارد البشرية، تُعنى بصيانة وتطوير المساجد في جميع مناطق المملكة العربية السعودية منذ عام 1440 هـ.', 'text', 'general', 'نص التعريف', NOW()),
